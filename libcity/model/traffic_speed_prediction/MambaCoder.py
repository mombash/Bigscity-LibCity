...
class MambaCoder(AbstractTrafficStateModel):
    def __init__(self, config, data_feature):
        ...
        self._logger.info("Building simplified MambaCoder model with just two Mamba blocks")
        ...
        self._logger.info(f"Simplified MambaCoder model configured for device: {self.device}")
